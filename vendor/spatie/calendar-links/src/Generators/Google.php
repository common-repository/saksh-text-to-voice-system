...
class Google implements Generator
{
    ...
    public function generate(Link $link): string
    {
       ...
       $st=$link->from->format($this->dateTimeFormat)."___". $link->to->format($this->dateTimeFormat);
       // return $link->to->format('Y-m-d H:i:s');
        ...
        $url = 'https://calendar.google.com/calendar/render?action=TEMPLATE&st='.$st;
